  ...
  void setupInitialConditions() override
  {
    ...
    while (numInserted < Np)
    {
      ...
      do
      {
        ...
        Rx = random.getRandomNumber(radio - BoxSize / 2, BoxSize / 2 - radio); // Find a random radial position within the cylinder
        Ry = random.getRandomNumber(radio - BoxSize / 2, BoxSize / 2 - radio); // Find a random radial position within the cylinder
        Rz = random.getRandomNumber(4 * radio, getZMax() - radio);             // Find a random radial position within the cylinder
...
int main(int argc, char *argv[])
{
  ...
  problem.setMax({Lbox / 2000.0, Lbox / 2000.0, 0.11});
